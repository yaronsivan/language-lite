...
- AVOID obvious cognates and international words that ${motherTongue} speakers already understand
${cognateExamples}
...
- Function words (donc, quindi, aber, sin embargo)
- Cultural concepts unique to the language
- Verbs with unique meanings or usage patterns
- Prepositions and particles that don't translate directly
- Idiomatic expressions appropriate for the level
...
Return your response in JSON format:
{
  ...
  getCognateExamples(targetLanguage, motherTongue) {
    ...
    const cognateMap = {
      'Italian': {
        'English': {
          avoid: ['problema/problem', 'difficile/difficult', 'importante/important', 'interessante/interesting', 'possibile/possible', 'famiglia/family', 'persona/person', 'momento/moment', 'situazione/situation', 'informazione/information'],
          examples: 'AVOID words like: problema, importante, possibile, famiglia, momento, informazione (obvious cognates)'
        }
      },
      'Spanish': {
        'English': {
